...
public class CodeGenerator {
    ...
    private static String projectPath = "D:\\A-Project\\A-ZSXQ\\Junw-pao\\junw-pao-server";    //代码生成路径
    private static String[] tableNames = new String[] {"team","user_team","tag"};    //需要生成代码的数据库表名
    private static String[] tablePrefix = new String[] { "TR_", "TS_", "V_", "T_" , "TT_", "czmk_", "view_", "hsmk_", "z_"};    //表前缀

    private static String url = "jdbc:mysql://localhost:3308/junw_pao";    //数据源url
